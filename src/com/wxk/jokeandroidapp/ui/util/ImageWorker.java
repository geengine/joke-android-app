...
public abstract class ImageWorker {
	...
	private boolean mFullImageShow = false;

	public void setFullImageShow(boolean bol) {
		mFullImageShow = bol;
	}
	...
	private class BitmapWorkerTask extends
			AsyncTask<Object, Void, WrapBitmapDrawable> {
		private Object data;
		 ...
		 */
		@Override
		protected WrapBitmapDrawable doInBackground(Object... params) {
			if (BuildConfig.DEBUG) {
			...
			Bitmap bitmap = null;
			WrapBitmapDrawable drawable = null;
			...
			if (bitmap != null) {
				if (Utils.hasHoneycomb()) {
					...
					// BitmapDrawable
					drawable = new WrapBitmapDrawable(mResources, bitmap);
		 ...
		 */
		@Override
		protected void onPostExecute(WrapBitmapDrawable value) {
		...
		@Override
		protected void onCancelled(WrapBitmapDrawable value) {
	...
	private void setImageDrawable(ImageView imageView, Drawable drawable) {
		...
		// full image show
		if (WrapBitmapDrawable.class.isInstance(drawable)) {
