...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private final static int OVER_PULL_REFRESH = 2; // 进入放手刷行状态
	private final static int EXIT_PULL_REFRESH = 3; // 松手后反弹加载状态
	...
	private final static int REFRESH_DONE = 3; // 数据加载完成
